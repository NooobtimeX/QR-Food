    ...
    >
      <div class="p-2">
        <div class="flex items-center justify-between">
          <h2 class="mb-4 text-xl font-bold text-gray-800">Notifications</h2>
          <!-- Close Button -->
          <button
...
const fetchTablesWithNotifications = async () => {
  ...
  const currentNotificationCount = tablesWithNotifications.value.length;
